...
@interface GSIntroductionView ()<UIScrollViewDelegate>
{
...
+(instancetype)sharedWithImages:(NSArray *)imageNames{
    images = imageNames;
    isScrollOut = YES;
    launch = [[GSIntroductionView alloc] initWithFrame:CGRectMake(0, 0, SCREENSIZE.width, SCREENSIZE.height)];
...
-(void)createScrollView{
    launchScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, SCREENSIZE.width, SCREENSIZE.height)];
    ...
    launchScrollView.contentSize = CGSizeMake(SCREENSIZE.width * images.count, SCREENSIZE.height);
    [self addSubview:launchScrollView];
    for (int i = 0; i < images.count; i ++) {
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(i * SCREENSIZE.width, 0, SCREENSIZE.width, SCREENSIZE.height)];
    ...
    page = [[UIPageControl alloc] initWithFrame:CGRectMake(0, SCREENSIZE.height - 50, SCREENSIZE.width, 30)];
...
-(void)scrollViewWillBeginDragging:(UIScrollView *)scrollView{
    int cuttentIndex = (int)(scrollView.contentOffset.x + SCREENSIZE.width/2)/SCREENSIZE.width;
